    ...
    <Card padding="xl" hover>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: spacing.md }}>
        {notifications.map(notification => (
          ...
          onMouseEnter={(e) => {
            e.target.style.background = notification.unread ? currentColors.dangerLight : currentColors.borderLight;
            e.target.style.borderColor = notification.unread ? currentColors.danger : currentColors.primary;
          }}
          onMouseLeave={(e) => {
            e.target.style.background = notification.unread ? currentColors.dangerLight : currentColors.background;
            e.target.style.borderColor = notification.unread ? currentColors.danger : currentColors.border;
          }}
          >
            <div style={{ flex: 1 }}>
              <div style={{ 
